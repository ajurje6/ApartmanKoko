...
const Calendar = () => {
  ...
  useEffect(() => {
    const fetchCalendarData = async () => {
      try {
        const airbnbUrl = "https://apartmankoko-makarska-backend.onrender.com/api/calendar/airbnb";
        const bookingUrl = "https://apartmankoko-makarska-backend.onrender.com/api/calendar/booking";
